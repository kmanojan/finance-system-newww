...
CREATE TABLE IF NOT EXISTS invoice_types (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    name VARCHAR(255) NOT NULL,
    maps_to ENUM('income', 'expense') NOT NULL,
...
CREATE TABLE IF NOT EXISTS payment_milestones (
    ...
    status ENUM('pending', 'invoiced', 'skipped') DEFAULT 'pending',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS invoice_schedules (
    ...
    to_date DATE NULL,
    frequency ENUM('daily', 'weekly', 'bi-weekly', 'monthly', 'quarterly', 'yearly', 'custom') DEFAULT 'monthly',
...
CREATE TABLE IF NOT EXISTS budgets (
    ...
    currency VARCHAR(10) NOT NULL,
    period ENUM('monthly', 'yearly', 'one-time') NOT NULL,
    start_date DATE,
    end_date DATE,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
CREATE TABLE IF NOT EXISTS invoices (
    ...
    currency VARCHAR(10) NOT NULL,
    status ENUM('draft', 'pending_approval', 'sent', 'paid', 'partially_paid', 'overdue') DEFAULT 'draft',
...
CREATE TABLE IF NOT EXISTS payment_modes (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    payment_id INT NOT NULL,
    mode ENUM('cash', 'card', 'cheque', 'bank_transfer') NOT NULL,
    amount DECIMAL(15, 2) NOT NULL,
    bank_name VARCHAR(255),
    cheque_no VARCHAR(255),
    cheque_date DATE,
    cheque_status ENUM('pending', 'deposited', 'bounced') DEFAULT NULL,
    reference_no VARCHAR(255),
    notes TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (payment_id) REFERENCES payments(id) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS loan_interest_schedule (
    ...
    paid_date DATE,
    status ENUM('pending', 'partially_paid', 'paid', 'skipped', 'overdue') DEFAULT 'pending',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS reminders (
    ...
    status ENUM('pending', 'snoozed', 'settled', 'dismissed') DEFAULT 'pending',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS share_links (
    ...
    audience ENUM('client', 'partner') NOT NULL,
...
CREATE TABLE IF NOT EXISTS tax_types (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    name VARCHAR(255) NOT NULL,
    category ENUM('vat', 'wht', 'cit', 'other') NOT NULL,
