...
Route::get('/rich-editor/mentions', [\App\Http\Controllers\CKeditorController::class, 'mentions']);
Route::get('/api/rich-editor/mentions', [\App\Http\Controllers\CKeditorController::class, 'mentions']);
